...
import pygame
import maker_state
import Factory_Stage
import gameover_state

from Main_Character import Ninja
from Forest_Star import Star
global file
pygame.mixer.init
...
class Mainbgm:
    def __init__(self):
        self.bgm = pygame.mixer.Sound('Sounds\\Forest_Stage.wav')
...
def handle_events(frame_time):
    global file, start_time, current_time, ui,ninja , mainBGM
    events = get_events()
    for event in events:
        if event.type == SDL_QUIT:
            ...
            mainBGM.pausesong()
            game_framework.change_state(Factory_Stage)
        elif ui.score < 0:
            mainBGM.pausesong()
...
def update(frame_time):
    global object_list, ui, ninja, star, j, TimeInUpdate, ScoreDown
