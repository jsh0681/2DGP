...
class Mainbgm:
    def __init__(self):
        self.bgm = pygame.mixer.Sound('Sounds\\Factory_Stage.wav')
...
def handle_events(frame_time):
    ...
    for event in events:
        if event.type == SDL_QUIT:
            ...
            mainBGM.pausesong()
            game_framework.change_state(Snow_Stage)
        elif ui.score<=0:
            mainBGM.pausesong()
...
def draw(frame_time):
    global ninja,grass,star,background, object_list,ui,star
